const project = {
  "id": "115502",
  "slug": "ntub-115502-snap-to-learn",
  "repo": "115502",
  "title": "Snap to Learn 智慧日語情境學習平台",
  "shortName": "Snap to Learn",
  "subtitle": "拍照成教材，AI 陪練日語",
  "eyebrow": "115502 專業化展示版",
  "source": "五專第115502組 Snap to Learn 系統手冊",
  "mark": "ST",
  "accent": "#d94841",
  "accent2": "#2156c9",
  "accent3": "#f2c14e",
  ...
  "panels": [
    {
      "title": "即拍即學工作流",
      "text": "把使用者日常場景轉成日文單字、例句、發音與收藏卡片，避免傳統背單字和生活脫節。",
      "tag": "教材引擎"
    },
    {
      "title": "低壓力 AI 對話",
      "text": "依程度提供角色扮演，輸入後即時給文法修正、替代表達與鼓勵式回饋。",
      "tag": "AI Tutor"
    },
    {
      "title": "成就與留存",
      "text": "以連續學習、照片任務、小組挑戰與點數方案提升長期使用動機。",
      "tag": "Growth"
    }
  ],
  "workflow": [
  ...
  "records": [
    ...
    {
      "title": "コンビニで支払う",
      "meta": "便利商店會話 · AI 修正文法 3 處",
      "status": "完成"
    },
    {
      "title": "駅で道を聞く",
      "meta": "問路角色扮演 · 回答自然度 82%",
      "status": "進行中"
    }
  ],
  "insights": [
    "辨識結果需保留使用者可修正機制，避免 AI 錯字直接進入複習。",
    "會話回饋應分成文法、自然度、禮貌程度三欄，讓初學者可立即理解。",
    "點數與訂閱方案應透明呈現每日額度，避免學習中斷造成挫折。"
  ],
  "automation": [
    "照片自動標籤",
    "單字難度分級",
